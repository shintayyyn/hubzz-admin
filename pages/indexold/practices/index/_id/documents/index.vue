<template>
    ...
    <div class="table border-separate overflow-x-auto px-6" style="border-spacing: 0 10px;"> 
      ...
      <div
        ...
        :key="`surgery-${index}`"
        class="flex flex-col md:flex-row sm:flex-wrap justify-between px-2 py-2 border-l-8 border-yellow-500 md:border-l-0 md:table-row my-2 text-white no-underline shadow-lg rounded-lg bg-waterloo hover:bg-waterloo-light" 
      >
