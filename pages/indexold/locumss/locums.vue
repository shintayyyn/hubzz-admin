	...
	<div class="flex-1 flex flex-col py-2">
		<div class="flex flex-col md:flex-row justify-between px-6">
			<div class="flex py-2">
				...
				<button class="rounded-lg text-sm text-white mx-2 p-2 hover:text-black hover:bg-yellow-dark focus:outline-none" @click="searchSubmit">Go</button>
			</div>
			<!-- <AppSearch :name='search' :placeholder='search'/> -->
		...
		<div class="table border-separate overflow-x-auto mx-6" style="border-spacing: 0 10px;"> 
			...
			:key="`locumUser-${index}`" 
			:to="{ path: `/locums/${locumUser.id}?locums_tab=profile`, query: $route.query }" 
