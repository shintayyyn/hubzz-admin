  ...
  <div class="flex flex-col h-full">
    <div class="flex flex-row justify-start overflow-x-auto border-b border-gray-500 mb-4 pt-1">
      <nuxt-link
        ...
        :class="$route.path == `/user-management/${$route.params.id}` ? 'border-b-4 border-gray-500' : 'text-gray-600'"
      >
        User Info
      </nuxt-link>
      <nuxt-link
        ...
        class="md:mr-5 px-3 py-2 text-sm font-bold cursor-pointer whitespace-no-wrap"
        :class="$route.path == `/user-management/${$route.params.id}/edit` ? 'border-b-4 border-gray-500' : 'text-gray-600'"
      >
        Edit Info
      </nuxt-link>
      <nuxt-link
        ...
        class="md:mr-5 px-3 py-2 text-sm font-bold cursor-pointer whitespace-no-wrap"
        :class="$route.path == `/user-management/${$route.params.id}/change-password` ? 'border-b-4 border-gray-500' : 'text-gray-600'"
      >
        Change Password
      </nuxt-link>
    </div>
