  ...
  export default {
  	...
  	async asyncData({ app, route }) {
  		...
  		try {
  			...
  			let {
  				practice_type_page = 1,
  				practice_type_search = ''
  			} = route.query

  			let page = parseInt(practice_type_page)
  			...
  			if (practice_type_search) {

  				params.search = practice_type_search
  	...
  	methods: {
  		...
  		goToPage(page) {
  			...
  			const query = {
  				...this.$router.query,
  				practice_type_page: page
  			}

  			if (page === 1) {

  				delete query.practice_type_page
  		...
  		searchSubmit() {
  			...
  			query.practice_type_search = this.search

  			if (this.search === '') {

  				delete query.practice_type_search
