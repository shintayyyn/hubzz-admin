...
export default {
  ...
  async asyncData({ store, error }) {
    try {
      ...
      if (
        authAdminPermissions.includes('View Locums') === false &&
  ...
  created() {
    if (this.authAdminPermissions.includes('View Reports') && this.authAdminPermissions.includes('View Locums') === false) {
