  ...
  <div class="flex-1 flex flex-col overflow-auto py-2 px-4 md:px-8">
    ...
    <div class="flex flex-col">
      <div class="flex flex-col lg:flex-row w-full ">
        <!-- LOCUM REGISTRATIONS -->
        <div v-if="authAdminPermissions.includes('View Locums')" class="flex-1 rounded my-2 lg:mr-2 shadow-md bg-gray-300">
          <div class="m-4">
        ...
        <div v-if="authAdminPermissions.includes('View Practices')" class="flex-1 rounded my-2 lg:mx-2 shadow-md bg-gray-300">
          <div class="m-4">
            <div class="flex flex-row text-xs text-gray-800">
        ...
        <div
          v-if="authAdminPermissions.includes('View Locums') || authAdminPermissions.includes('View Practices')"
        ...
        <!-- BILLING TOTALS -->
        <div v-if="authAdminPermissions.includes('View Hubzz Invoices')" class="flex-1 rounded my-2 lg:ml-2 shadow-md bg-gray-300">
          <div class="m-4">
            <div class="flex flex-row text-xs text-gray-800">
              <div>Billing</div>
      ...
      <div class="flex flex-col lg:flex-row w-full ">
        ...
        <!-- JOBS IN PLATFORM -->
        <div
          v-if="authAdminPermissions.includes('View Locum Jobs') || authAdminPermissions.includes('View Practice Sessions')"
          class="flex-1 rounded my-2 lg:mx-2 shadow-md bg-gray-300"
        >
          <div class="m-4">
            <div class="flex flex-row text-xs text-gray-800">
        ...
        <!-- DISPUTES -->
        <div
          v-if="authAdminPermissions.includes('View Practice Sessions') || authAdminPermissions.includes('View Locum Jobs')"
...
export default {
  ...
  methods: {
    ...
    async getLocumRegistrations() {
      await this.$store.dispatch('dashboard/fetchLocumRegistrations', {
    ...
    async getPracticeRegistrations() {
      await this.$store.dispatch('dashboard/fetchPracticeRegistrations', {
        registered_at_date_start: this.filter.registered_at_date_start,
        registered_at_date_end: this.filter.registered_at_date_end,
        post_code: this.filter.post_code,
        proximity: this.filter.proximity
    ...
    async getSuccessfulReferrals() {
      await this.$store.dispatch('dashboard/fetchSuccessfulReferrals', {
        registered_at_date_start: this.filter.registered_at_date_start,
        registered_at_date_end: this.filter.registered_at_date_end,
        post_code: this.filter.post_code,
        proximity: this.filter.proximity
    ...
    async getBillingTotals() {
      await this.$store.dispatch('dashboard/fetchBillingTotals', {
        registered_at_date_start: this.filter.registered_at_date_start,
        registered_at_date_end: this.filter.registered_at_date_end,
        post_code: this.filter.post_code,
        proximity: this.filter.proximity
    ...
    async getLocumsInPlatform() {
      await this.$store.dispatch('dashboard/fetchLocumsInPlatform', {
        registered_at_date_start: this.filter.registered_at_date_start,
        registered_at_date_end: this.filter.registered_at_date_end,
        post_code: this.filter.post_code,
        proximity: this.filter.proximity
    ...
    async getPracticesInPlatform() {
      await this.$store.dispatch('dashboard/fetchPracticesInPlatform', {
        registered_at_date_start: this.filter.registered_at_date_start,
        registered_at_date_end: this.filter.registered_at_date_end,
        post_code: this.filter.post_code,
        proximity: this.filter.proximity
    ...
    async getJobsInPlatform() {
      await this.$store.dispatch('dashboard/fetchJobsInPlatform', {
        registered_at_date_start: this.filter.registered_at_date_start,
        registered_at_date_end: this.filter.registered_at_date_end,
        post_code: this.filter.post_code,
        proximity: this.filter.proximity
    ...
    async getDisputes() {
      await this.$store.dispatch('dashboard/fetchDisputes', {
        registered_at_date_start: this.filter.registered_at_date_start,
        registered_at_date_end: this.filter.registered_at_date_end,
        post_code: this.filter.post_code,
        proximity: this.filter.proximity
