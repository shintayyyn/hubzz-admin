    ...
    computed: {
      ...
      columnDetails () {
        return [
          ...
          {
            title: 'First Actived At (DST)',
            key: 'first_actived_at_in_gb_formatted',
            sort_key: 'first_actived_at_in_gb_formatted',
            column: (item) => item.first_actived_at_in_gb_formatted ? item.first_actived_at_in_gb_formatted: '',
            justify: 'start',
            flexGrow: 1,
            flexShrink: 0,
          },
