          ...
          <div class="w-full text-gray-300 text-sm p-2">
              ...
              <div class="flex flex-row justify-start">
                <div class="flex flex-col w-full">
                  <span class="pl-4 py-2 font-bold text-xs sm:text-sm">
                    <span>{{ jobPart ? jobPart.id : null }}</span>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-col py-2">
              ...
              <div class="flex flex-row justify-start">
                <div class="flex flex-col w-full">
                  <span class="pl-4 py-2 font-bold text-xs sm:text-sm">
                    <span>{{ jobPart ? jobPart.job_id : null }}</span>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-col py-2">
              ...
              <div class="flex flex-row justify-start">
                <div class="flex flex-col w-full">
                  <span class="pl-4 py-2 font-bold text-xs sm:text-sm">
                    <span>{{ jobPart && jobPart.job ? jobPart.job.type : null }}</span>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-col py-2">
              ...
              <div class="flex flex-row justify-start">
                <div class="flex flex-col w-full">
                  <span class="pl-4 py-2 font-bold text-xs sm:text-sm">
                    <span>{{ jobPart ? jobPart.job_part_number : null }}</span>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-col py-2">
              ...
              <div class="flex flex-row justify-start">
                <div class="flex flex-col w-full">
                  <span class="pl-4 py-2 font-bold text-xs sm:text-sm">
                    <span>{{ jobPart ? jobPart.status : null }}</span>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="flex flex-col py-2">
              ...
              <div class="flex flex-row justify-start">
                <div class="flex flex-col w-full">
                  <span class="pl-4 py-2 font-bold text-xs sm:text-sm">
                    <span>{{
                      jobPart && jobPart.created_at
                        ? $moment(jobPart.created_at, 'YYYY-MM-DD[T]HH:mm:ss.SSS').format('DD/MM/YYYY | HH:mm')
                        : null
                    }}</span>
                  </span>
                </div>
              ...
              <div class="flex flex-row justify-start">
                <div class="flex flex-col w-full">
                  <span class="pl-4 py-2 font-bold text-xs sm:text-sm overflow-auto bg-trout" style="height: 300px;">
                    <span class="whitespace-pre-wrap">{{ jobPart ? JSON.stringify(jobPart, null, 4) : null }}</span>
                  </span>
                </div>
              </div>
            </div>
...
<script>
  export default {
    ...
    mounted () {
      this.loading = true
      this.$axios.get(`/api/v1/admin/job-parts/${this.$route.params.id}`).then((response) => {
