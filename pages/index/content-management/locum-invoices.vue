      ...
      columnDetails () {
        return [
          ...
          // },
          {
            ...
            key: 'issued_at',
            sort_key: 'issued_at',
            column: (item) => item.issued_at_in_gb_formatted ? item.issued_at_in_gb_formatted : '',
            justify: 'start',
            flexGrow: 1,
            flexShrink: 0,
          },
          {
            title: 'Approved At (DST)',
            key: 'approved_at',
            sort_key: 'approved_at',
            column: (item) => item.approved_at_in_gb_formatted ? item.approved_at_in_gb_formatted : '',
            justify: 'start',
            flexGrow: 1,
            flexShrink: 0,
          },
          {
            ...
            key: 'paid_at',
            sort_key: 'paid_at',
            column: (item) => item.paid_at_in_gb_formatted ? item.paid_at_in_gb_formatted : '',
            justify: 'start',
            flexGrow: 1,
            flexShrink: 0,
          },
