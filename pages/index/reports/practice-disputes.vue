      ...
      columnDetails () {
        return [
          ...
          },
          {
            ...
            key: 'practice_id',
            sort_key: null,
            column: (item) => item.average_disputes_processing_days !== null  ? `${item.average_disputes_processing_days > 0 ? item.average_disputes_processing_days.toFixed(2) : 'Less Than 1'} Day(s)` : 'N/A',
            justify: 'start',
            flexGrow: 1,
            flexShrink: 0,
          },
