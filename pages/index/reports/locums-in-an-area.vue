  ...
  <div class="report-modal p-4 md:p-8 shadow-lg">
    <div class="page-overlap flex-1 flex flex-col self-end bg-trout">
      ...
      <div class="w-full text-xs overflow-x-auto mt-1">
        ...
        <div
          v-for="locumsInAnAreaItem in locumsInAnArea"
          :key="getLocumsInAnAreaKey(locumsInAnAreaItem)"
          class="flex bg-white"
        >
          <span class="flex-1 py-2 pl-8 pr-2">{{ locumsInAnAreaItem.area }}</span>
          <span class="flex-1 p-2 text-center">{{ locumsInAnAreaItem.profession }}</span>
          <span class="flex-1 p-2 text-center">{{ locumsInAnAreaItem.number_locums_registered }}</span>
          <span class="flex-1 p-2 text-center">{{ locumsInAnAreaItem.status }}</span>
        </div>
      </div>
