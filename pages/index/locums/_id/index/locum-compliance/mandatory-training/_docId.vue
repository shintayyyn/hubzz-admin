<template>
  <div class="compliance-modal shadow-lg">
    ...
    <LocumComplianceFile
      v-if="locumUser && locumDetailMandatoryTraining"
      :user="locumUser"
      :locumComplianceDocument="locumDetailMandatoryTraining"
    />
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      this.loading = true
      this.$axios.get(`/api/v1/admin/locum-detail-mandatory-trainings/${locumDetailMandatoryTrainingId}`).then((response) => {
