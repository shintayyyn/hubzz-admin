<template>
	<div class="billing-modal p-4 md:p-8 shadow-lg">
		...
		<div class="flex w-full overflow-hidden max-w-2xl">
			<div class="w-full overflow-hidden my-1 mx-1 rounded-lg bg-waterloo">
				...
				<div class="m-2">
					...
					<nuxt-link
						...
						class="flex flex-col cursor-pointer md:flex-row px-2 md:px-0 py-2 my-2 rounded-lg border-l-8 border-yellow-500 md:border-l-0 text-white no-underline shadow-lg bg-waterloo-light hover:bg-waterloo transition-hover"
						draggable="false"
					>
						<div
