  ...
  <div>
    <div class="page-overlap flex-1 flex flex-col self-end">
      ...
      <div class="flex-col justify-start items-center w-full border p-3 rounded-lg flex my-2">
        ...
        <div class="flex flex-row w-full items-center">
          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppDate v-model="dateStart" label="Job Part Date Start" format="YYYY-MM-DD" />
          </div>

          <div class="md:px-1 w-full lg:w-1/4 md:w-1/3">
            <AppDate v-model="dateEnd" label="Job Part Date End" format="YYYY-MM-DD" />
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    getLocumInvoiceJobParts() {
      ...
      Promise.all([
        this.$axios
          .get('/api/v1/admin/reports/locum-invoice-job-parts/count', {
            params
          })
          .then(responses => {
        ...
        this.$axios
          .get('/api/v1/admin/reports/locum-invoice-job-parts', {
            params: {
              ...params,
    ...
    downloadCsv() {
      ...
      this.$axios
        .post(
          '/api/v1/admin/reports/locum-invoice-job-parts/generate-key',
          {
