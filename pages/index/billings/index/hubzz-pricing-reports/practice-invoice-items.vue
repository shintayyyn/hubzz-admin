    ...
    computed: {
      ...
      columnDetails () {
        return [
          ...
          {
            title: 'Total Hours',
            key: 'job_part_total_final_hours',
            sort_key: 'job_part_total_final_hours',
            column: (item) => item.job_part_total_final_hours ? `${item.job_part_total_final_hours.toFixed(2)} Hours` : "N/A",
            justify: 'end',
            flexGrow: 1,
            flexShrink: 0,
          },
