      ...
      columnDetails () {
        return [
          ...
          },
          {
            ...
            column: (item) => item.final_hours ? item.final_hours : "N/A",
            justify: 'end',
            flexGrow: 1,
            flexShrink: 0,
          },
          {
            title: 'Type',
            key: 'practice_invoice_item_type',
            sort_key: 'practice_invoice_item_type',
            column: (item) => item.practice_invoice_item_type ? item.practice_invoice_item_type : "N/A",
            justify: 'end',
            flexGrow: 1,
            flexShrink: 0,
          },
