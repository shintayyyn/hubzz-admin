<template>
  <section>
    ...
    <div class="px-10 mt-5">
      <div class="rounded-lg text-white bg-charade shadow-lg pt-10 px-5 pb-5 mb-10" style="font-family:Nunito">
        <div class="font-bold mt-4 mb-2">Locum</div>
        <div v-for="item in locum_faqs" :key="item.id">
          <div
            class="m-1 rounded-lg bg-trout p-4 flex justify-between cursor-pointer"
