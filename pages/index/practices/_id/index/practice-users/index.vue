  ...
  <div class=" mt-2">
    <div v-if="!$route.params.roleId" class="flex flex-row overflow-x-auto border-b border-gray-500 mb-2">
      <nuxt-link
        ...
        :class="$route.path == `/practices/${practice.id}/practice-users` ? 'border-b-4 border-gray-500' : 'text-gray-600'"
      >
        Users
      </nuxt-link>
      ...
      <nuxt-link
        ...
        class="md:mr-5 px-3 py-2 text-sm font-bold cursor-pointer whitespace-no-wrap"
        :class="$route.path.includes(`/user-roles`) ? 'border-b-4 border-gray-500' : 'text-gray-600'"
      >
        Roles
      </nuxt-link>
    </div>
