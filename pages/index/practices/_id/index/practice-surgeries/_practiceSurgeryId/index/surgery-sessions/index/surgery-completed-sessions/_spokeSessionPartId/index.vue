<template>
  <div class="job-modal shadow-lg">
    <div class="mt-6 mx-4 md:mx-8 my-2">
        <nuxt-link :to="{ path: `/practices/${practiceId}/practice-surgeries/${$route.params.practiceSurgeryId}/surgery-sessions/surgery-completed-sessions`}" class="cursor-pointer">
