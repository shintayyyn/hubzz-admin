<template>
  <div>
    <PracticeAvailableSessions :practice="practice" :practice_surgery="practice_surgery" />
  </div>
</template>
<script>
import PracticeAvailableSessions from '@/components/Practices/Sessions/PracticeAvailableSessions'
export default {
  components:{
    PracticeAvailableSessions
  },
  computed:{
