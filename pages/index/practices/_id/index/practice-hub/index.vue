                  ...
                  >
                    ...
                    <div class="p-2">
                      <div class="flex flex-col md:flex-row">
                        ...
                        <p
                          class
                        >{{practiceHub.max_hourly_rate_limit ?'£ '+ practiceHub.max_hourly_rate_limit : 'N/A'}}</p>
                      </div>
                      <div class="flex flex-col md:flex-row">
                        <p class="font-semibold md:w-1/2">Maximum Half Day Rate Limit</p>
                        <p
                          class
                        >{{practiceHub.max_halfday_rate_limit ?'£ '+ practiceHub.max_halfday_rate_limit : 'N/A'}}</p>
                      </div>
                      ...
                      <div class="flex flex-col md:flex-row">
                        ...
                        <p
                          class
                        >{{practiceHub.max_wholeday_rate_limit ?'£ '+ practiceHub.max_wholeday_rate_limit : 'N/A'}}</p>
                      </div>
                      ...
                      <div class="flex flex-col md:flex-row">
                        ...
                        <p
                          class
                        >{{practiceHub.max_ooh_rate_limit ?'£ '+ practiceHub.max_ooh_rate_limit : 'N/A'}}</p>
                      </div>
                      ...
                      <div class="flex flex-col md:flex-row">
                        ...
                        <p
                          class
                        >{{practiceHub.max_excess_hours ? practiceHub.max_excess_hours+' Hrs' : 'N/A'}}</p>
                      </div>
                    </div>
                  </div>
