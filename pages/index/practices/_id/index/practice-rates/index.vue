...
export default {
  ...
  created(){
    this.toPutPracticeRate.gp_rate = this.practice.rates.length > 0 ? this.practice.rates[0].rate : ""
    this.toPutPracticeRate.others_rate = this.practice.rates.length > 0 ? this.practice.rates[1].rate : ""
  },
  computed:{
    practice(){
