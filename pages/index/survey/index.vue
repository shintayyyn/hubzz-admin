      ...
      <div class="rounded-lg border bg-gray-200 py-3 md:py-5">
        <div class="w-full inline-flex flex-wrap justify-between font-bold mb-2 px-3 md:px-5">
          ...
          <div class="flex items-center">
            <AppButton :label="'Add'" :icon="'add-rectangle'" :nuxtLink="{ path: `/survey/add-locum-questionnaire` }" class="text-sm" />
        ...
        <div class="w-full inline-flex flex-wrap justify-between font-bold mb-2 px-3 md:px-5">
          ...
          <div class="flex items-center">
            <AppButton :label="'Add'" :icon="'add-rectangle'" :nuxtLink="{ path: `/survey/add-practice-questionnaire` }" class="text-sm" />
...
export default {
  ...
  methods: {
    ...
    deleteSurveyQuestion() {
      ...
      this.$axios
        .delete(`/api/v1/admin/survey-questions/${this.toDeleteSurveyQuestionId}`)
        .then(() => {
          this.$store.commit('SET_NOTIFICATION', {
            enabled: true,
            status: 'success',
    ...
    onDrop(evt, toIndex, domain) {
      ...
      this.$axios
        .$put(`/api/v1/admin/survey-questions/update-positions`, {
