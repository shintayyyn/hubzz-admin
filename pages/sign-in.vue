<template>
  <div class="h-full w-full flex flex-col overflow-auto xl:justify-center">
    <div class="flex justify-center items-start" style="height: 600px;">
      <div
        class="flex flex-col px-10 py-6 m-4 rounded-lg shadow-lg"
        style="width: 600px; background-color: #55565A;"
      >
        <div class="relative">
          <label class="text-white">Email address</label>
          <span
            v-show="emailErrorMessage && !showEmailFocus"
            class="text-white bg-red absolute pin-r p-1 text-xs"
        ...
        <div class="relative">
          ...
          <span
            v-show="passwordErrorMessage && !showPasswordFocus"
            class="text-white bg-red absolute pin-r p-1 text-xs"
        ...
        <input
          ...
          v-model="password"
          @keyup.enter="login"
          :class="showPasswordFocus ? 'border-yellow-dark' : passwordErrorMessage ? 'border-red' : 'border-white-dark'"
        ...
        <button
          @click="login"
          class="self-center rounded-lg p-5 font-bold"
