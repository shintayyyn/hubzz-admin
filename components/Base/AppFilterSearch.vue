	...
	<section>
		...
		<div class="relative flex flex-col py-2 mb-6">
			...
			<div class="relative flex flex-row flex-wrap justify-start">
				...
				<div>
					<input
						...
						placeholder="Select.."
						ref="input"
						class="bg-transparent border-b-2 focus:border-yellow-400 focus:outline-none py-3 font-bold text-xs sm:text-sm"
						@focus="toggled = true"
						@blur="toggled = false"
			...
			<div class="relative flex flex-col w-full z-10">
				...
				>
					<div
						class="py-2 px-3 cursor-pointer text-xs sm:text-sm text-black"
