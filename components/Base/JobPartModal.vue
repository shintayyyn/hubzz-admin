<template>
  <div class="m-6">
    ...
    <div class="flex flex-wrap my-4">
      <div class="text-2xl text-white font-semibold mr-4">{{specificJobPart.job ? specificJobPart.job.title:null }}</div>
      <div class="flex">
    ...
    <div class="flex flex-wrap">
      <div class="flex order-2 md:order-1 flex-wrap h-full xl:w-2/3 sm:w-full overflow-auto text-sm no-underline shadow-lg rounded-lg bg-waterloo shadow">
        ...
        <!-- GOOGLE MAPS -->
        <div class="w-full m-2 md:m-4 overflow-hidden" v-if="specificJobPart.job ? specificJobPart.job.platform_job : null">
      ...
      <div class="flex order-1 md:order-2 w-full xl:w-1/3">
        <div v-if="specificJobPart.job.job_parts.length > 0" class="py-2 md:py-0 md:mx-4 overflow-hidden w-full">
