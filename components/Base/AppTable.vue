      ...
      >
        ...
        <div v-if="disabledHeadings === false" class="row hidden md:flex justify-start font-bold leading-none text-sm">
          ...
          >
            ...
            <svgicon v-if="column.sortable" :name="sortIcon(column.dataIndex)" height="12" width="12" color="#fff" />
          </div>
        </div>
            ...
            >
              ...
              >
                <template v-if="Array.isArray(dataCell(item, column))">
                  <div v-for="(itemName, basis) in dataCell(item, column)" :key="`${itemName}-${basis}`">
                    {{ itemName }}
                  </div>
                </template>
                ...
                <template v-else>
                  ...
                  <template v-else-if="column.class && column.class.includes('localDate') && dataCell(item, column) !== '(none)'">
