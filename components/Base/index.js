// Barrel exports for Base components
...
export { default as AppCheckboxSlider } from './AppCheckboxSlider.vue'
export { default as AppConfirm } from './AppConfirm.vue'
export { default as AppConfirmationModal } from './AppConfirmationModal.vue'
export { default as AppDate } from './AppDate.vue'
...
// Modern table alias
export { default as AppTableNew } from './AppTable.vue'
export { default as AppTime } from './AppTime.vue'
export { default as JobPartModal } from './JobPartModal.vue'
// JobSchedules delegates to AppSchedules with context="job"; alias to canonical schedules
export { default as JobSchedules } from './AppSchedules.vue'
