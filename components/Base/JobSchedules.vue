<template>
  <div>
    <div class="mt-2 md:my-0 md:mx-2 text-white font-semibold">Schedules</div>
      ...
      <div class="text-xs sm:text-sm overflow-y-auto" style="max-height:205px;">
        <div style="position:sticky;top:0" class="flex">
          <p
            ...
            :style="['Completed', 'Approved'].includes(modalJobPart.status) ? 'min-width:100px;max-width:100px' : 'min-width:190px;max-width:190px'"
          >DATE</p>
          <p
          ...
          <p
            class="text-center bg-gray-400 p-1 font-bold text-xs"
            :style="['Completed', 'Approved'].includes(modalJobPart.status) ? 'min-width:100px;max-width:100px' : 'min-width:180px;max-width:180px'"
          >SHIFT</p>
          <p
            class="text-center bg-gray-400 p-1 font-bold text-xs"
            :style="['Completed', 'Approved'].includes(modalJobPart.status) ? 'min-width:100px;max-width:100px' : 'min-width:180px;max-width:180px'"
