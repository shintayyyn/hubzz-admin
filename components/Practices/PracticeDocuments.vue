    ...
    <div class="flex flex-col mx-2 text-white"> 
      ...
      >
        ...
        <div class="w-full md:w-1/4 py-2 md:px-2 flex flex-col md:flex-row md:items-center">
          ...
          <div class="w-full flex md:flex-col lg:flex-row items-center justify-between md:justify-start">
              ...
              <div v-if="document.practiceSpecificDoc" class="flex text-white text-xs py-2 xl:py-0">
                ...
                class="bg-blue flex items-center text-center rounded-full text-white no-underline px-6 py-2">
                  <svgicon
                    name="folder"
                    width="16"
                    height="16"
