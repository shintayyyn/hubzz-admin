	...
	<div class="flex flex-col rounded-lg">
		...
		<div class="flex flex-col lg:flex-row">
			...
			>
				<div class="flex flex-wrap">
					...
					<div class="w-full md:w-1/2 text-gray-300 text-sm">
						...
						<p
							class="flex text-white text-sm md:px-2 mb-2"
						>{{practice.surgery.clinical_commissioning_group ? practice.surgery.clinical_commissioning_group.name:null}}</p>
						...
						<div v-if="toEdit == false">
							...
							<div class="flex items-center mb-2">
								...
								<span
									...
									tabindex="1"
								>
									<svgicon name="info" width="21" height="21" color="white transparent black" class="ml-2"></svgicon>
								</span>
							</div>
						...
						>
							...
							<div class="flex items-center mb-4">
								...
								<span
									...
									tabindex="1"
								>
									<svgicon name="info" width="21" height="21" color="white transparent black"></svgicon>
								</span>
							</div>
							<AppDate
			...
			>
				...
				<div class="px-1 py-4">
					<ul class>
						<p class="font-bold" v-if="practice.status !== 'Active'">Profile</p>
						...
						>User</p>
						<li class="flex px-2" v-if="practiceUser && practiceUser.status !== 'Active'">
						...
						<li class="flex px-2" v-if="practice.rates && !practice.rates.length">
