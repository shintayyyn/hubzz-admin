    ...
    <div class="overflow-x-auto overflow-y-hidden">
      ...
      <div v-if="locumApprovedJobParts.length == 0">
        ...
        <div
          ...
          style="font-family: Nunito"
        >
          This locum has no approved jobs.
        </div>
      </div>
      <div v-else>
        <AppJobHeaderSort
        ...
        <div class="w-full overflow-x-auto">
          ...
          <div
            ...
            @click="$router.push(`/locums/${$route.params.id}/locum-jobs/locum-approved-jobs/${item.id}`)"
          >
  ...
  export default {
    ...
    methods: {
      async getJobPartsPromiseAll () {
        ...
        this.$store.commit("jobs/SET_LOCUM_APPROVED_JOBS_COUNT", responseCount.data.count)
        ...
        this.$store.commit("jobs/SET_LOCUM_APPROVED_JOBS", response.data.job_parts)
