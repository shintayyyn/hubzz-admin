    ...
    <div class="overflow-x-auto overflow-y-hidden">
      ...
      <div v-if="cancelledJobs.length === 0">
        ...
        <div
          ...
          style="font-family: Nunito"
        >
          This locum had no case of cancelled job yet.
        </div>
      </div>
      <div v-else>
        <AppJobHeaderSort :locumUser="user" :tabStatus="'Cancelled'" :currentPage="currentPage" />
        <div class="w-full overflow-x-auto">
          ...
          <div
            ...
            @click="$router.push(`/locums/${$route.params.id}/locum-jobs/locum-cancelled-jobs/${item.id}`)"
          >
  ...
  export default {
    ...
    methods: {
      async getJobPartsPromiseAll () {
        ...
        this.$store.commit("jobs/SET_LOCUM_CANCELLED_JOBS_COUNT", responseCount.data.count)
        ...
        this.$store.commit("jobs/SET_LOCUM_CANCELLED_JOBS", response.data.job_parts)
