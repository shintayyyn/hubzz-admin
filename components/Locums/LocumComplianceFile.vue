		...
		<main class="shadow-lg rounded-lg bg-waterloo mx-4 md:mx-12 mb-6 p-4">
            ...
            "
              ...
              "
						...
						>
							<p class="font-bold text-base">Reference</p>
							<p class="text-white">{{ locumComplianceDocument.reference }}</p>
						</div>
              ...
              "
						...
						>
							...
							<div v-if="locumComplianceDocument.status == 'Rejected'" class="pb-2 mb-2">
								...
								>{{ locumComplianceDocument && locumComplianceDocument.note ? locumComplianceDocument.note : 'N/A' }}</p>
							</div>
...
export default {
	...
	mounted() {
		...
		if (this.locumComplianceDocument) {
			...
			const selectedComplianceDocumentRejectReason = complianceDocumentRejectReasonSeletionList.find(
